...
private:
    ...
    CController*            ParseBRANCH_LEVEL2(QDomNode *node, CController* controller);
    ...
    void            SaveBranchLevel1(QDomElement* parentNode, CController* controller);
