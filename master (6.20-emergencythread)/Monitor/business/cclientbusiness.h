...
public:
    ...
    void DeviceStartStatus(int canportAddress, int distributionAdd, int loopAdd, int deviceAdd,
                           QString directionStatus, QString directionAndTwinkleStatus, QDateTime time);
...
class emergencyThread : public QThread
{
    Q_OBJECT
public:
    explicit emergencyThread(QObject *parent = NULL)
        : QThread(parent)
    {
    }
signals:
...
class firePointEmergencyByGroupThread : public QThread
{
    Q_OBJECT
public:
    explicit firePointEmergencyByGroupThread(QObject *parent = NULL)
        : QThread(parent)
    {
    }
signals:
...
class firePointEmergencyByLayoutPageThread : public QThread
{
    Q_OBJECT
public:
    explicit firePointEmergencyByLayoutPageThread(QObject *parent = NULL)
        : QThread(parent)
    {
    }
signals:
...
class firePointEmergencyByDistributionThread : public QThread
{
    Q_OBJECT
public:
    explicit firePointEmergencyByDistributionThread(QObject *parent = NULL)
        : QThread(parent)
    {
    }
signals:
