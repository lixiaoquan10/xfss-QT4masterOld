...
void CProcessClient::procRecvData(const QByteArray &byte)
{
    ...
    switch (type) {
        ...
        {
            CMsgDeviceInfo* msgDeviceInfo = static_cast<CMsgDeviceInfo*>(msgStruct);
            CGlobal::instance()->processController()->manualDeviceEmergency(msgDeviceInfo, true);
            break;
        }
        case NCT_DeviceEmergencyStop:
        {
            CMsgDeviceInfo* msgDeviceInfo = static_cast<CMsgDeviceInfo*>(msgStruct);
            CGlobal::instance()->processController()->manualDeviceEmergency(msgDeviceInfo, false);
            break;
        } 
...
//            CGlobal::instance()->processController()->setLedupdateTime2s();
            ...
            CGlobal::instance()->processDistribution()->readDeviceType();
            CGlobal::instance()->processDistribution()->readDeviceType();
//            CGlobal::instance()->processDistribution()->reLogin();
            break;
        }
        //全部清除注册
        case NCT_Unlogin:
        ...
        case NCT_LoginInfoLoop:
        {
            ...
            CGlobal::instance()->processDistribution()->reLogin(msglogin->nDistributeID,msglogin->nLoopID);
            CGlobal::instance()->processDistribution()->reLogin(msglogin->nDistributeID,msglogin->nLoopID);
            CGlobal::instance()->processDistribution()->reLogin(msglogin->nDistributeID,msglogin->nLoopID);
            break;
        }
        ...
        {
            CMsgObjectStatus* msgObjectStatus = static_cast<CMsgObjectStatus*>(msgStruct);
            CGlobal::instance()->processController()->DeviceAdd(msgObjectStatus);
            break;
        }
        //修改设备类型
        case NCT_DeviceType:
        {
            CMsgObjectStatus* msgObjectStatus = static_cast<CMsgObjectStatus*>(msgStruct);
            CGlobal::instance()->processController()->DeviceType(msgObjectStatus);
            break;
        }
        //设备测试开始
        ...
        {
            CMsgDeviceInfo* msgDeviceInfo = static_cast<CMsgDeviceInfo*>(msgStruct);
            CGlobal::instance()->processController()->manualDeviceTest(msgDeviceInfo);
            break;
        }
        //灯具默认点亮
        ...
        {
            CMsgDeviceInfo* msgDeviceInfo = static_cast<CMsgDeviceInfo*>(msgStruct);
            CGlobal::instance()->processController()->DeviceDefaultLighten(msgDeviceInfo,true);
            break;
        }
        //灯具默认熄灭
        ...
        {
            CMsgDeviceInfo* msgDeviceInfo = static_cast<CMsgDeviceInfo*>(msgStruct);
            CGlobal::instance()->processController()->DeviceDefaultLighten(msgDeviceInfo,false);
            break;
        }
        //标志灯默认方向
        ...
        {
            CMsgObjectStatus* msgObjectStatus = static_cast<CMsgObjectStatus*>(msgStruct);
            CGlobal::instance()->processController()->DeviceDefaultDirection(msgObjectStatus);
            break;
        }
        //标志灯方向控制
        ...
        {
            CMsgObjectStatus* msgObjectStatus = static_cast<CMsgObjectStatus*>(msgStruct);
            CGlobal::instance()->processController()->DeviceDirectionControl(msgObjectStatus);
            break;
        }
        //标志灯闪灯配置
        ...
        {
            CMsgObjectStatus* msgObjectStatus = static_cast<CMsgObjectStatus*>(msgStruct);
            CGlobal::instance()->processController()->DeviceFlashConfig(msgObjectStatus);
            break;
        }
        //标志灯闪灯控制
        ...
        {
            CMsgObjectStatus* msgObjectStatus = static_cast<CMsgObjectStatus*>(msgStruct);
            CGlobal::instance()->processController()->DeviceFlashControl(msgObjectStatus);
            break;
        }
        //设备复位
        ...
        {
            CMsgDeviceInfo* msgDeviceInfo = static_cast<CMsgDeviceInfo*>(msgStruct);
            CGlobal::instance()->processController()->manualDeviceReset(msgDeviceInfo);
            break;
        }
        //节能模式
        case NCT_EnergyMode:
        ...
        {
            CMsgObjectStatus* msgObjectStatus = static_cast<CMsgObjectStatus*>(msgStruct);
            CGlobal::instance()->processController()->ChangeControl(msgObjectStatus);
            break;
        }
        //自带电池灯具关闭备电输出
        ...
        {
            CMsgObjectStatus* msgObjectStatus = static_cast<CMsgObjectStatus*>(msgStruct);
            CGlobal::instance()->processController()->CloseBatteryOut(msgObjectStatus);
            break;
        }
        //配电箱应急回路输出控制
        ...
        {
            CMsgObjectStatus* msgObjectStatus = static_cast<CMsgObjectStatus*>(msgStruct);
            CGlobal::instance()->processController()->SetLoopOutStatus(msgObjectStatus);
            break;
        }
        //读取配电箱应急回路输出状态
        ...
        {
            CMsgObjectStatus* msgObjectStatus = static_cast<CMsgObjectStatus*>(msgStruct);
            CGlobal::instance()->processController()->ReadLoopOutStatus(msgObjectStatus);
            break;
        }
        //信息记录页码
        case NCT_RecordPage:
