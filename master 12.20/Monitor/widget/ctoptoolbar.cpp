...
void CTopToolBar::slottimeout()
{
    ...
    QString str = "/home/xfss/root/" + QString::number(i) + ".png";
    image.save(str);
}
...
void CTopToolBar::slotStop()
{
    ...
    if(QDialog::Accepted == m_Administrator.exec()) {
        ...
        else
        {
            ...
            QMessageBox::information(this, "信息", "系统应急停止失败！");
...
void CTopToolBar::slotSelfTest()
{
    ...
    {
        CGlobal::instance()->m_HaveDialog = true;
        QMessageBox::information(this, "信息", "系统自检失败！");
        CGlobal::instance()->m_HaveDialog = false;
    }  
}
...
void CTopToolBar::slotMonthlyTest()
{
    ...
    if(QDialog::Accepted == m_Administrator.exec()) {
        ...
        {
            CGlobal::instance()->m_HaveDialog = true;
            QMessageBox::information(this, "信息", "系统月检失败！");
            CGlobal::instance()->m_HaveDialog = false;
        }
    } else {
...
void CTopToolBar::slotYearTest()
{
    ...
    if(QDialog::Accepted == m_Administrator.exec()) {
        ...
        {
            CGlobal::instance()->m_HaveDialog = true;
            QMessageBox::information(this, "信息", "系统年检失败！");
            CGlobal::instance()->m_HaveDialog = false;
        }
    } else {
...
void CTopToolBar::slotManual()
{
    ...
    if(QDialog::Accepted == m_Administrator.exec()) {
        ...
        {
            CGlobal::instance()->m_HaveDialog = true;
            QMessageBox::information(this, "信息", "手动疏散失败！");
            CGlobal::instance()->m_HaveDialog = false;
        }
...
void CTopToolBar::slotAuto()
{
    ...
    if(QDialog::Accepted == m_Administrator.exec()) {
        ...
        {
            CGlobal::instance()->m_HaveDialog = true;
            QMessageBox::information(this, "信息", "自动疏散失败！");
            CGlobal::instance()->m_HaveDialog = false;
        }
...
//    if(QDialog::Accepted == CGlobal::instance()->TimeInterval()->exec()) {
...
//    if(QMessageBox::Yes == QMessageBox::question(this, CGlobal::instance()->m_strApplicationTitle, tr("Are you sure want to recover the controller, this operate will be clear all the data in project?"), QMessageBox::Yes, QMessageBox::No))
//    {
...
//                                     tr("The controller recover success."));
//    }
//}
...
void CTopToolBar::slotAbout()
{
    ...
    msgBox.setText("名称:" + CGlobal::instance()->m_strApplicationTitle +
                   tr("\n") + "版本:" + "V1.01CA");
    msgBox.exec();
    CGlobal::instance()->m_HaveDialog = false;
    m_btnSystemTool->setChecked(true);
...
{
    CGlobal::instance()->m_HaveDialog = true;
    int ret = QMessageBox::information(NULL, "信息",
