...
static const char qt_meta_stringdata_CMsgObjectStatusInfo[] = {
    "CMsgObjectStatusInfo\0"
};
...
const QMetaObjectExtraData CMsgObjectStatusInfo::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CMsgObjectStatusInfo::staticMetaObject = {
    { &CMsgStructBase::staticMetaObject, qt_meta_stringdata_CMsgObjectStatusInfo,
      qt_meta_data_CMsgObjectStatusInfo, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CMsgObjectStatusInfo::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CMsgObjectStatusInfo))
        return static_cast<void*>(const_cast< CMsgObjectStatusInfo*>(this));
