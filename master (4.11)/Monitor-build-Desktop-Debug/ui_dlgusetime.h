...
public:
    ...
    void setupUi(QDialog *dlgUseTime)
    {
        ...
        m_linkmanPhoneNumber->setMinimumSize(QSize(0, 25));
        m_linkmanPhoneNumber->setMaximumSize(QSize(16777215, 25));
        ...
        m_LocalNumber->setMinimumSize(QSize(0, 25));
        m_LocalNumber->setMaximumSize(QSize(16777215, 25));
        ...
        m_rPowerCode->setMinimumSize(QSize(0, 25));
        m_rPowerCode->setMaximumSize(QSize(16777215, 25));
