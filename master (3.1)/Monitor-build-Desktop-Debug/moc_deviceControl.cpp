...
static const char qt_meta_stringdata_deviceControl[] = {
    "deviceControl\0"
};
...
const QMetaObjectExtraData deviceControl::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject deviceControl::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_deviceControl,
      qt_meta_data_deviceControl, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &deviceControl::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_deviceControl))
