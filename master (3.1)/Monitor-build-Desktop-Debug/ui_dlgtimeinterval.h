...
public:
    ...
    QCheckBox *PrintOCheckBox;
    QCheckBox *PrintFCheckBox;
    QCheckBox *PrintECheckBox;
    QGroupBox *SoundBox;
    ...
    void setupUi(QDialog *dlgTimeInterval)
    {
        ...
        PrinterBox = new QGroupBox(dlgTimeInterval);
        PrinterBox->setObjectName(QString::fromUtf8("PrinterBox"));
        PrinterBox->setGeometry(QRect(20, 10, 150, 100));
        QFont font1;
        font1.setPointSize(12);
        PrinterBox->setFont(font1);
        verticalLayout = new QVBoxLayout(PrinterBox);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        PrintOCheckBox = new QCheckBox(PrinterBox);
        PrintOCheckBox->setObjectName(QString::fromUtf8("PrintOCheckBox"));
        PrintOCheckBox->setFont(font1);
        PrintOCheckBox->setStyleSheet(QString::fromUtf8(""));

        verticalLayout->addWidget(PrintOCheckBox);

        PrintFCheckBox = new QCheckBox(PrinterBox);
        PrintFCheckBox->setObjectName(QString::fromUtf8("PrintFCheckBox"));
        PrintFCheckBox->setFont(font1);

        verticalLayout->addWidget(PrintFCheckBox);

        PrintECheckBox = new QCheckBox(PrinterBox);
        PrintECheckBox->setObjectName(QString::fromUtf8("PrintECheckBox"));
        PrintECheckBox->setFont(font1);

        verticalLayout->addWidget(PrintECheckBox);

        SoundBox = new QGroupBox(dlgTimeInterval);
        SoundBox->setObjectName(QString::fromUtf8("SoundBox"));
        SoundBox->setGeometry(QRect(200, 10, 130, 80));
        ...
        MYcheckBox->setGeometry(QRect(360, 10, 120, 80));
        ...
        EnergyModeBox->setGeometry(QRect(980, 10, 120, 60));
        ...
        MYcheckTimeBox->setGeometry(QRect(20, 130, 140, 90));
        ...
        EmergencyBox->setGeometry(QRect(510, 10, 260, 110));
        ...
        VersionBox->setGeometry(QRect(200, 110, 250, 140));
        ...
        version_ledkey->setMaximumSize(QSize(100, 28));
        version_ledkey->setFont(font1);
        version_ledkey->setReadOnly(true);

        horizontalLayout_13->addWidget(version_ledkey);

        pushButton_ledkey = new QPushButton(VersionBox);
        pushButton_ledkey->setObjectName(QString::fromUtf8("pushButton_ledkey"));
        pushButton_ledkey->setMinimumSize(QSize(0, 28));
        pushButton_ledkey->setMaximumSize(QSize(60, 28));
        pushButton_ledkey->setFont(font1);

        horizontalLayout_13->addWidget(pushButton_ledkey);
        ...
        hostIPSetBox->setGeometry(QRect(980, 100, 270, 170));
        ...
        label_myip->setMinimumSize(QSize(0, 28));
        label_myip->setMaximumSize(QSize(16777215, 28));
        ...
        sizePolicy1.setHeightForWidth(m_myip->sizePolicy().hasHeightForWidth());
        m_myip->setSizePolicy(sizePolicy1);
        m_myip->setMinimumSize(QSize(0, 28));
        ...
        label_gateway->setMinimumSize(QSize(0, 28));
        label_gateway->setMaximumSize(QSize(16777215, 28));
        ...
        sizePolicy1.setHeightForWidth(m_gateway->sizePolicy().hasHeightForWidth());
        m_gateway->setSizePolicy(sizePolicy1);
        m_gateway->setMinimumSize(QSize(0, 28));
        ...
        label_subnetMask->setMinimumSize(QSize(0, 28));
        label_subnetMask->setMaximumSize(QSize(16777215, 28));
        ...
        sizePolicy1.setHeightForWidth(m_subnetMask->sizePolicy().hasHeightForWidth());
        m_subnetMask->setSizePolicy(sizePolicy1);
        m_subnetMask->setMinimumSize(QSize(0, 28));
        ...
        UseTimeBox->setGeometry(QRect(1120, 10, 200, 70));
        ...
        timeBox->setGeometry(QRect(20, 270, 190, 140));
        ...
        pingBox->setGeometry(QRect(230, 270, 270, 100));
        ...
        sizePolicy1.setHeightForWidth(m_pingIP->sizePolicy().hasHeightForWidth());
        m_pingIP->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(m_pingResult->sizePolicy().hasHeightForWidth());
        m_pingResult->setSizePolicy(sizePolicy1);
        ...
        cloudIPSetBox->setGeometry(QRect(490, 140, 231, 100));
        ...
        sizePolicy1.setHeightForWidth(m_hostip->sizePolicy().hasHeightForWidth());
        m_hostip->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(m_com->sizePolicy().hasHeightForWidth());
        m_com->setSizePolicy(sizePolicy1);
        ...
        comStatusBox->setGeometry(QRect(750, 140, 190, 100));
        ...
        sizePolicy1.setHeightForWidth(m_cloudStatus->sizePolicy().hasHeightForWidth());
        m_cloudStatus->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(m_masterStatus->sizePolicy().hasHeightForWidth());
        m_masterStatus->setSizePolicy(sizePolicy1);
        ...
        StartRuleBox->setGeometry(QRect(800, 10, 161, 110));
    ...
    void retranslateUi(QDialog *dlgTimeInterval)
    {
        ...
        PrinterBox->setTitle(QApplication::translate("dlgTimeInterval", "\346\211\223\345\215\260\346\234\272\351\205\215\347\275\256", 0, QApplication::UnicodeUTF8));
        PrintOCheckBox->setText(QApplication::translate("dlgTimeInterval", "\346\211\223\345\215\260\346\223\215\344\275\234\344\277\241\346\201\257", 0, QApplication::UnicodeUTF8));
        PrintFCheckBox->setText(QApplication::translate("dlgTimeInterval", "\346\211\223\345\215\260\346\225\205\351\232\234\344\277\241\346\201\257", 0, QApplication::UnicodeUTF8));
        PrintECheckBox->setText(QApplication::translate("dlgTimeInterval", "\346\211\223\345\215\260\345\272\224\346\200\245\344\277\241\346\201\257", 0, QApplication::UnicodeUTF8));
        ...
        pushButton_ledkey->setText(QApplication::translate("dlgTimeInterval", "\350\257\273\345\217\226", 0, QApplication::UnicodeUTF8));
        ...
        hostIPSetBox->setTitle(QApplication::translate("dlgTimeInterval", "\346\234\254\346\234\272IP\345\234\260\345\235\200", 0, QApplication::UnicodeUTF8));
