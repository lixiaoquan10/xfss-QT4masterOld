...
static const char qt_meta_stringdata_CCommunicationManager[] = {
    ...
    "handleSendLedData()\0handleSendCan1Data()\0"
    "handleSendCan2Data()\0handleLedReciveData()\0"
...
void CCommunicationManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: { bool _r = _t->sendLedData((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const int(*)>(_a[2])),(*reinterpret_cast< const QByteArray(*)>(_a[3])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 5: _t->handleSendLedData(); break;
        case 6: _t->handleSendCan1Data(); break;
        case 7: _t->handleSendCan2Data(); break;
        case 8: _t->handleLedReciveData(); break;
        case 9: _t->handleCan1ReciveData(); break;
        case 10: _t->handleCan2ReciveData(); break;
        case 11: _t->updataRecentSerialNumber((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
