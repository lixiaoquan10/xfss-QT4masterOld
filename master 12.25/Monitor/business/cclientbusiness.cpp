                    ...
                    if(type == 0x01){//读运行参数
                        ...
                        if(distribution){
                            if(loopAddress == 0 && deviceAddress == 0)
                            {
                                ...
                                {
                                    distribution->setValue(DISTRIBUTION_VALUE_EXTERNALV,(double(msgObjectStatus->strdata.mid(16, 2).toInt(&ok, 16)*256+msgObjectStatus->strdata.mid(14, 2).toInt(&ok, 16)))/10);
                                    distribution->setValue(DISTRIBUTION_VALUE_BAT1V,(double(msgObjectStatus->strdata.mid(20, 2).toInt(&ok, 16)*256+msgObjectStatus->strdata.mid(18, 2).toInt(&ok, 16)))/10);
                                    distribution->setValue(DISTRIBUTION_VALUE_BAT2V,(double(msgObjectStatus->strdata.mid(24, 2).toInt(&ok, 16)*256+msgObjectStatus->strdata.mid(22, 2).toInt(&ok, 16)))/10);
                                }
                                else if(msgObjectStatus->strdata.mid(8, 2).toInt(&ok, 16) == 0x03 && byte.count() == 13)
                                {
                                    distribution->setValue(DISTRIBUTION_VALUE_BAT3V,(double(msgObjectStatus->strdata.mid(16, 2).toInt(&ok, 16)*256+msgObjectStatus->strdata.mid(14, 2).toInt(&ok, 16)))/10);
                                    distribution->setValue(DISTRIBUTION_VALUE_BAT1T,double(msgObjectStatus->strdata.mid(20, 2).toInt(&ok, 16)*256+msgObjectStatus->strdata.mid(18, 2).toInt(&ok, 16)));
                                    distribution->setValue(DISTRIBUTION_VALUE_BAT2T,double(msgObjectStatus->strdata.mid(24, 2).toInt(&ok, 16)*256+msgObjectStatus->strdata.mid(22, 2).toInt(&ok, 16)));
                                }
                                else if(msgObjectStatus->strdata.mid(8, 2).toInt(&ok, 16) == 0x04 && byte.count() == 13)
                                {
                                    distribution->setValue(DISTRIBUTION_VALUE_BAT3T,double(msgObjectStatus->strdata.mid(16, 2).toInt(&ok, 16)*256+msgObjectStatus->strdata.mid(14, 2).toInt(&ok, 16)));
                                    CLoop* loop = distribution->loopByAdd(1);
                                    if(loop){
                                        loop->setValue(LOOP_VALUE_V,(double(msgObjectStatus->strdata.mid(20, 2).toInt(&ok, 16)*256+msgObjectStatus->strdata.mid(18, 2).toInt(&ok, 16)))/10);
                                        loop->setValue(LOOP_VALUE_A,(double(msgObjectStatus->strdata.mid(24, 2).toInt(&ok, 16)*256+msgObjectStatus->strdata.mid(22, 2).toInt(&ok, 16)))/100);
                                    }
                                }
                                else if(msgObjectStatus->strdata.mid(8, 2).toInt(&ok, 16) == 0x05 && byte.count() == 13)
                                {
                                    ...
                                    if(loop){
                                        loop->setValue(LOOP_VALUE_V,(double(msgObjectStatus->strdata.mid(16, 2).toInt(&ok, 16)*256+msgObjectStatus->strdata.mid(14, 2).toInt(&ok, 16)))/10);
                                        loop->setValue(LOOP_VALUE_A,(double(msgObjectStatus->strdata.mid(20, 2).toInt(&ok, 16)*256+msgObjectStatus->strdata.mid(18, 2).toInt(&ok, 16)))/100);
                                    }
                                    loop = distribution->loopByAdd(3);
                                    if(loop)
                                        loop->setValue(LOOP_VALUE_V,(double(msgObjectStatus->strdata.mid(24, 2).toInt(&ok, 16)*256+msgObjectStatus->strdata.mid(22, 2).toInt(&ok, 16)))/10);
                                }
                                else if(msgObjectStatus->strdata.mid(8, 2).toInt(&ok, 16) == 0x06 && byte.count() == 13)
                                {
                                    CLoop* loop = distribution->loopByAdd(3);
                                    if(loop){
                                        loop->setValue(LOOP_VALUE_A,(double(msgObjectStatus->strdata.mid(16, 2).toInt(&ok, 16)*256+msgObjectStatus->strdata.mid(14, 2).toInt(&ok, 16)))/100);
                                    }
                                ...
                                else if(msgObjectStatus->strdata.mid(8, 2).toInt(&ok, 16) == 0x0c && byte.count() == 11)
                                {
                                    ...
                                    distribution->setValue(DISTRIBUTION_VALUE_BATV,(double(msgObjectStatus->strdata.mid(20, 2).toInt(&ok, 16)*256+msgObjectStatus->strdata.mid(18, 2).toInt(&ok, 16)))/10);
                                }
...
//                                        serverDeviceRealtimeData(distribution);
                        ...
                        if(distributionAddress == 0x3f)
                        {
                            ...
                            int softwareVersion = msgObjectStatus->strdata.mid(18, 2).toInt(&ok, 16);
                        ...
                        else if(loopAddress == 0 && deviceAddress == 0)
                        {
                            ...
                            if(msgObjectStatus->strdata.mid(8, 2).toInt(&ok, 16) == 0x01)
                            {
                                if(byte.count() < 14)
                                    return;
                                distribution->setValue(DISTRIBUTION_VALUE_CPUVERSION,msgObjectStatus->strdata.mid(14, 2).toInt(&ok, 16));
                                distribution->setValue(DISTRIBUTION_VALUE_POWVERSION,msgObjectStatus->strdata.mid(16, 2).toInt(&ok, 16));
                                distribution->setValue(DISTRIBUTION_VALUE_LCDVERSION,msgObjectStatus->strdata.mid(18, 2).toInt(&ok, 16));
                                distribution->setValue(DISTRIBUTION_VALUE_ABUS1VERSION,msgObjectStatus->strdata.mid(20, 2).toInt(&ok, 16));
                                distribution->setValue(DISTRIBUTION_VALUE_ABUS2VERSION,msgObjectStatus->strdata.mid(22, 2).toInt(&ok, 16));
                                distribution->setValue(DISTRIBUTION_VALUE_ABUS3VERSION,msgObjectStatus->strdata.mid(24, 2).toInt(&ok, 16));
                                distribution->setValue(DISTRIBUTION_VALUE_ABUS4VERSION,msgObjectStatus->strdata.mid(26, 2).toInt(&ok, 16));
                            }
                            else if(msgObjectStatus->strdata.mid(8, 2).toInt(&ok, 16) == 0x02)
                            {
                                if(byte.count() < 14)
                                    return;
                                distribution->setValue(DISTRIBUTION_VALUE_ABUS5VERSION,msgObjectStatus->strdata.mid(14, 2).toInt(&ok, 16));
                                distribution->setValue(DISTRIBUTION_VALUE_ABUS6VERSION,msgObjectStatus->strdata.mid(16, 2).toInt(&ok, 16));
                                distribution->setValue(DISTRIBUTION_VALUE_ABUS7VERSION,msgObjectStatus->strdata.mid(18, 2).toInt(&ok, 16));
                                distribution->setValue(DISTRIBUTION_VALUE_ABUS8VERSION,msgObjectStatus->strdata.mid(20, 2).toInt(&ok, 16));
                                distribution->setValue(DISTRIBUTION_VALUE_ABUS9VERSION,msgObjectStatus->strdata.mid(22, 2).toInt(&ok, 16));
                                distribution->setValue(DISTRIBUTION_VALUE_ABUS10VERSION,msgObjectStatus->strdata.mid(24, 2).toInt(&ok, 16));
                                distribution->setValue(DISTRIBUTION_VALUE_ABUS11VERSION,msgObjectStatus->strdata.mid(26, 2).toInt(&ok, 16));
                            }
                            else if(msgObjectStatus->strdata.mid(8, 2).toInt(&ok, 16) == 0x3f)
                            {
                                if(byte.count() < 8)
                                    return;
                                distribution->setValue(DISTRIBUTION_VALUE_ABUS12VERSION,msgObjectStatus->strdata.mid(14, 2).toInt(&ok, 16));
                                //判断客户端是否连接
                                if(CGlobal::instance()->TimeInterval()->isMasterConnect())
                                {
                                    //服务端回复集中电源软件版本信息
                        ...
                        else
                        {
                            ...
                            CLoop* loop = distribution->loopByAdd(loopAddress);
                            CDevice* device = loop->deviceByAdd(deviceAddress);
                            device->setValue(DEVICE_VALUE_SOFTWARENUMBER,msgObjectStatus->strdata.mid(16, 2).toInt(&ok, 16)*256+msgObjectStatus->strdata.mid(14, 2).toInt(&ok, 16));
                            device->setValue(DEVICE_VALUE_SOFTWAREVERSION,msgObjectStatus->strdata.mid(18, 2).toInt(&ok, 16));
                            device->setValue(DEVICE_VALUE_TYPE_ID,msgObjectStatus->strdata.mid(20, 2).toInt(&ok, 16));
                            //服务端回复灯具软件版本信息
