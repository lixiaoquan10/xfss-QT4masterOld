...
CMsgObjectStatus::CMsgObjectStatus() :
    CMsgStructBase(), nType(0), nPanelID(0), nDisID(0), nLoopID(0), nDeviceID(0), nStatusID(0),
...
{
    stream>>nType>>nPanelID>>nDisID>>nLoopID>>nDeviceID>>nStatusID>>nValue>>nTimes>>strText>>nLoginStatus>>nCommunicationStatus>>strdata>>ndata
