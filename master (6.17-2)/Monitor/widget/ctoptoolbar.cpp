...
void CTopToolBar::slotDeviceInfo()
{
    ...
    CGlobal::instance()->centerFrameContainer()->insertWidget(0, CGlobal::instance()->loginInformation()); // 插入新的小部件
...
void CTopToolBar::slotCanInfo()
{
    ...
    // 替换界面
    CGlobal::instance()->centerFrameContainer()->removeWidget(CGlobal::instance()->centerFrameContainer()->widget(0)); // 移除原来的小部件
    CGlobal::instance()->centerFrameContainer()->insertWidget(0, CGlobal::instance()->programCanDeviceView()); // 插入新的小部件
    CGlobal::instance()->centerFrameContainer()->setCurrentIndex(0);
    m_btnCanInfoTool->setChecked(true);
}
...
void CTopToolBar::slotDayInformation()
{
    ...
    // 替换界面
    CGlobal::instance()->centerFrameContainer()->removeWidget(CGlobal::instance()->centerFrameContainer()->widget(0)); // 移除原来的小部件
    CGlobal::instance()->centerFrameContainer()->insertWidget(0, CGlobal::instance()->SystemRecord()); // 插入新的小部件
    CGlobal::instance()->centerFrameContainer()->setCurrentIndex(0);
    m_btnBrowseInfoTool->setChecked(true);
}
...
void CTopToolBar::slotListView()
{
    // 替换界面
    CGlobal::instance()->centerFrameContainer()->removeWidget(CGlobal::instance()->centerFrameContainer()->widget(0)); // 移除原来的小部件
    CGlobal::instance()->centerFrameContainer()->insertWidget(0, CGlobal::instance()->dlgDeviceInfomation()); // 插入新的小部件
    CGlobal::instance()->centerFrameContainer()->setCurrentIndex(0);
     CGlobal::instance()->DlgDevices()->getDeviceInfo();
     m_btnTableShowTool->setChecked(true);
}
...
void CTopToolBar::slotLayoutView()
{
    // 替换界面
    CGlobal::instance()->centerFrameContainer()->removeWidget(CGlobal::instance()->centerFrameContainer()->widget(0)); // 移除原来的小部件
    CGlobal::instance()->centerFrameContainer()->insertWidget(0, CGlobal::instance()->CenterFrame()); // 插入新的小部件
    CGlobal::instance()->centerFrameContainer()->setCurrentIndex(0);
    m_btnTableShowTool->setChecked(true);
}
...
void CTopToolBar::slotSystemSetup()
{
    ...
    // 替换界面
    CGlobal::instance()->centerFrameContainer()->removeWidget(CGlobal::instance()->centerFrameContainer()->widget(0)); // 移除原来的小部件
    CGlobal::instance()->centerFrameContainer()->insertWidget(0, CGlobal::instance()->TimeInterval()); // 插入新的小部件
    CGlobal::instance()->centerFrameContainer()->setCurrentIndex(0);
    m_btnParamTool->setChecked(true);
}
...
{
    CGlobal::instance()->ClientBusiness()->clearExpectObject(true);
    CGlobal::instance()->controller()->clearStatus();
    CGlobal::instance()->controller()->setStatus(OBJS_Online, 1);
    for(int i=3; i<=CGlobal::instance()->m_nCanNumber+2; i++)
    {
        CCanport* canport = CGlobal::instance()->controller()->canportByAddress(i);
        if(!canport)
