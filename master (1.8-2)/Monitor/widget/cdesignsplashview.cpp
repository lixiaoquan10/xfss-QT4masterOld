...
void CDesignSplashView::slot_Lighten()
{
    ...
    msgDeviceInfo.deviceInfo.insert(DI_LoopId, m_device->deviceValue(DEVICE_VALUE_LOOPADDR).toInt());
    msgDeviceInfo.deviceInfo.insert(DI_DistributionId, m_device->deviceValue(DEVICE_VALUE_DISTRIBUTIONADDR).toInt());
...
void CDesignSplashView::slot_Left()
{
    ...
    msgobjectstatus.nDisID = m_device->deviceValue(DEVICE_VALUE_DISTRIBUTIONADDR).toInt();
    msgobjectstatus.nLoopID = m_device->deviceValue(DEVICE_VALUE_LOOPADDR).toInt();
