...
public:
    ...
    void setEnableUpdate(bool enable) { m_enableUpdate = enable; }
    bool enableUpdate() { return m_enableUpdate; }
    ...
    void setDeviceForbid(bool iscontrol) { m_isDeviceForbid = iscontrol ;}
