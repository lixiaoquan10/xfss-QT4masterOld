...
bool panelWidget(const QWidget *widget)
{
    ...
    // zrx
    if(CStyleHelper::hasAllowWidget(widget->window()))
        return true;
...
{
public:
    explicit CManhattanStylePrivate();
    void init();
...
public:
    ...
    CStyleAnimator animator;
};

CManhattanStylePrivate::CManhattanStylePrivate() :
    ...
    closeButtonPixmap(QLatin1String(":/core/images/close.png"))
{
}

CManhattanStyle::CManhattanStyle(const QString &baseStyleName)
    : QProxyStyle(QStyleFactory::create(baseStyleName)),
    d(new CManhattanStylePrivate())
{
}

CManhattanStyle::~CManhattanStyle()
{
    delete d;
    d = 0;
}

QPixmap CManhattanStyle::generatedIconPixmap(QIcon::Mode iconMode, const QPixmap &pixmap, const QStyleOption *opt) const
{
    return QProxyStyle::generatedIconPixmap(iconMode, pixmap, opt);
}

QSize CManhattanStyle::sizeFromContents(ContentsType type, const QStyleOption *option,
...
QRect CManhattanStyle::subElementRect(SubElement element, const QStyleOption *option, const QWidget *widget) const
{
    return QProxyStyle::subElementRect(element, option, widget);
}

QRect CManhattanStyle::subControlRect(ComplexControl control, const QStyleOptionComplex *option,
                                     SubControl subControl, const QWidget *widget) const
{
    return QProxyStyle::subControlRect(control, option, subControl, widget);
}

QStyle::SubControl CManhattanStyle::hitTestComplexControl(ComplexControl control, const QStyleOptionComplex *option,
                                                         const QPoint &pos, const QWidget *widget) const
{
    return QProxyStyle::hitTestComplexControl(control, option, pos, widget);
}

int CManhattanStyle::pixelMetric(PixelMetric metric, const QStyleOption *option, const QWidget *widget) const
{
    int retval = 0;
...
QPalette CManhattanStyle::standardPalette() const
{
    return QProxyStyle::standardPalette();
}

void CManhattanStyle::polish(QApplication *app)
{
    return QProxyStyle::polish(app);
}

void CManhattanStyle::unpolish(QApplication *app)
{
...
{
    QColor color = CStyleHelper::panelTextColor(lightColored);
...
void CManhattanStyle::polish(QWidget *widget)
{
    ...
    if (panelWidget(widget)) {
        ...
        if (qobject_cast<QToolButton*>(widget)) {
            ...
            widget->setMaximumHeight(CStyleHelper::navigationWidgetHeight() - 2);
        }
            ...
            widget->setFixedHeight(CStyleHelper::navigationWidgetHeight());
        else if (qobject_cast<QStatusBar*>(widget))
            widget->setFixedHeight(CStyleHelper::navigationWidgetHeight() + 2);
...
void CManhattanStyle::unpolish(QWidget *widget)
{
...
void CManhattanStyle::polish(QPalette &pal)
{
    QProxyStyle::polish(pal);
}

QIcon CManhattanStyle::standardIconImplementation(StandardPixmap standardIcon, const QStyleOption *option, const QWidget *widget) const
{
    QIcon icon;
    switch (standardIcon) {
...
QPixmap CManhattanStyle::standardPixmap(StandardPixmap standardPixmap, const QStyleOption *opt,
...
int CManhattanStyle::styleHint(StyleHint hint, const QStyleOption *option, const QWidget *widget,
...
void CManhattanStyle::drawPrimitive(PrimitiveElement element, const QStyleOption *option,
                                   QPainter *painter, const QWidget *widget) const
{
    ...
    if (widget && (element == PE_PanelButtonTool) && !animating) {
        ...
        if (doTransition) {
            ...
            CAnimation *anim = d->animator.widgetAnimation(widget);
    ...
    case PE_IndicatorDockWidgetResizeHandle:
        painter->fillRect(option->rect, CStyleHelper::borderColor());
        break;
    ...
    case PE_PanelLineEdit:
        {
            ...
            if (option->state & State_Enabled)
                CStyleHelper::drawCornerImage(d->lineeditImage, painter, option->rect, 5, 5, 5, 5);
            else
                CStyleHelper::drawCornerImage(d->lineeditImage_disabled, painter, option->rect, 5, 5, 5, 5);

            if (option->state & State_HasFocus || option->state & State_MouseOver) {
                QColor hover = CStyleHelper::baseColor();
    ...
    case PE_PanelStatusBar:
        {
            ...
            QColor startColor = CStyleHelper::shadowColor().darker(164);
            QColor endColor = CStyleHelper::baseColor().darker(130);
            ...
            painter->setPen(CStyleHelper::borderColor().darker(110));
    ...
    case PE_IndicatorToolBarSeparator:
        {
            QColor separatorColor = CStyleHelper::borderColor();
    ...
    case PE_IndicatorToolBarHandle:
        {
            ...
            QColor dark = CStyleHelper::borderColor();
            dark.setAlphaF(0.4);

            QColor light = CStyleHelper::baseColor();
            light.setAlphaF(0.4);
    ...
    case PE_IndicatorArrowLeft:
        {
            CStyleHelper::drawArrow(element, painter, option);
        }
        break;
...
void CManhattanStyle::drawControl(ControlElement element, const QStyleOption *option,
                                 QPainter *painter, const QWidget *widget) const
{
    if (!panelWidget(widget))
    ...
    case CE_MenuBarItem:
        ...
        if (const QStyleOptionMenuItem *mbi = qstyleoption_cast<const QStyleOptionMenuItem *>(option)) {
            QColor highlightOutline = CStyleHelper::borderColor().lighter(120);
            bool act = mbi->state & State_Selected && mbi->state & State_Sunken;
            bool dis = !(mbi->state & State_Enabled);
            CStyleHelper::menuGradient(painter, option->rect, option->rect);
            ...
            if (act) {
                // Fill|
                QColor baseColor = CStyleHelper::baseColor();
    ...
    case CE_ComboBoxLabel:
        if (const QStyleOptionComboBox *cb = qstyleoption_cast<const QStyleOptionComboBox *>(option)) {
            if (panelWidget(widget)) {
                ...
                painter->setPen(CStyleHelper::panelTextColor());
                painter->drawText(editRect.adjusted(1, 0, -1, 0), Qt::AlignLeft | Qt::AlignVCenter, text);
    ...
    case CE_MenuBarEmptyArea: {
            CStyleHelper::menuGradient(painter, option->rect, option->rect);
            painter->save();
            painter->setPen(CStyleHelper::borderColor());
    ...
    case CE_ToolBar:
        {
            ...
            if (horizontal)
                CStyleHelper::horizontalGradient(painter, gradientSpan, rect, drawLightColored);
            else
                CStyleHelper::verticalGradient(painter, gradientSpan, rect, drawLightColored);
            ...
            if (horizontal) {
                ...
                QColor lighter(CStyleHelper::sidebarHighlight());
                if (drawLightColored)
...
void CManhattanStyle::drawComplexControl(ComplexControl control, const QStyleOptionComplex *option,
                                        QPainter *painter, const QWidget *widget) const
{
    if (!panelWidget(widget))
...
void CManhattanStyle::drawButtonSeparator(QPainter *painter, const QRect &rect, bool reverse) const
{
