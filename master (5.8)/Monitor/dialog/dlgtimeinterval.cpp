    ...
    ui(new Ui::dlgTimeInterval)
{
    ...
    QIcon icon(":/images/startinfo.png"); // 替换为你的图标路径
    TriangleButton *triangleButton = new TriangleButton(icon,this);
//    triangleButton->setIcon(QIcon(":/images/startinfo.png"));
    // 设置按钮样式表，隐藏按钮的边框和背景
    triangleButton->setStyleSheet("border: none; background: none;");
    triangleButton->setGeometry(1200,400,30,30);
    connect(triangleButton, SIGNAL(clicked()), this, SLOT(on_pushButton_UseTime_clicked()));
