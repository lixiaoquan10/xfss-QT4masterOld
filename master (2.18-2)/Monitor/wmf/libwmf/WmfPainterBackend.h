...
class WmfPainterBackend : public WmfAbstractBackend
{
public:
    ...
    void setOutputSize(const QSizeF& size) {
        mOutputSize = size;
    }
    void setOutputSize(qreal width, qreal height)
    {
        mOutputSize = QSizeF(width, height);
    }
    QSizeF outputSize() { return mOutputSize; }
