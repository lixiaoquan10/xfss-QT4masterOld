...
{
    qDebug() << "resetControllerTreeView:0";
    // 保存当前选择的索引
    QModelIndex currentIndex = m_controllerTreeView->currentIndex();
    qDebug() << "resetControllerTreeView:1";
    //重置树形结构
    m_controllerTreeView->reset();
    qDebug() << "resetControllerTreeView:2";
    // 展开所有节点
    m_controllerTreeView->expandAll();
    qDebug() << "resetControllerTreeView:3";
    // 恢复之前选择的索引
//    m_controllerTreeView->setCurrentIndex(currentIndex);
    ...
    qDebug() << "resetControllerTreeView:4";
}
