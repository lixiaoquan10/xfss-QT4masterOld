...
//            if(pointRotationAngle >= 0 && pointRotationAngle < 90)
//            {
//                p1 = QPointF(p1.x()-xValue,p1.y()+yValue);
//                p2 = QPointF(p2.x()-xValue,p2.y()+yValue);
//            }
//            else if(pointRotationAngle >= 90 && pointRotationAngle < 180)
//            {
//                p1 = QPointF(p1.x()-xValue,p1.y()+yValue);
//                p2 = QPointF(p2.x()-xValue,p2.y()+yValue);
//            }
//            else if(pointRotationAngle >= -180 && pointRotationAngle < -90)
//            {
//                p1 = QPointF(p1.x()-xValue,p1.y()+yValue);
//                p2 = QPointF(p2.x()-xValue,p2.y()+yValue);
//            }
//            else if(pointRotationAngle >= -90 && pointRotationAngle < 0)
//            {
//                p1 = QPointF(p1.x()-xValue,p1.y()+yValue);
//                p2 = QPointF(p2.x()-xValue,p2.y()+yValue);
//            }
