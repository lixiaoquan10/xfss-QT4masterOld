...
public:
    ...
    void setMaxFirePointDeviceAddress(int n) { m_maxFirePointDeviceAddress = m_maxFirePointDeviceAddress > n ? m_maxFirePointDeviceAddress : n; }
    void setMaxFirePointLoopAddress(int n) { m_maxFirePointLoopAddress = m_maxFirePointLoopAddress > n ? m_maxFirePointLoopAddress : n; }
    void setMaxFirePointAddress(int n) { m_maxFirePointAddress = m_maxFirePointAddress > n ? m_maxFirePointAddress : n; }
