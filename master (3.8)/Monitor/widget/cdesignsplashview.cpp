...
void CDesignSplashView::setLampConnectionArrow(QPixmap* background, CDevice* startLamp, CDevice* endLamp, int joint)
{
    ...
    else
    {
        ...
        if (line.intersect(starttopEdge, &intersection1) == QLineF::BoundedIntersection
                || line.intersect(startbottomEdge, &intersection1) == QLineF::BoundedIntersection
                || line.intersect(startleftEdge, &intersection1) == QLineF::BoundedIntersection
                || line.intersect(startrightEdge, &intersection1) == QLineF::BoundedIntersection) {
    ...
    else
    {
        ...
        if (line.intersect(endtopEdge, &intersection2) == QLineF::BoundedIntersection
                || line.intersect(endbottomEdge, &intersection2) == QLineF::BoundedIntersection
                || line.intersect(endleftEdge, &intersection2) == QLineF::BoundedIntersection
                || line.intersect(endrightEdge, &intersection2) == QLineF::BoundedIntersection) {
    ...
    QPointF arrowline[8];
    double line_compare = 2.5*m_changeValue/100.0;
    double arrow_compare1 = 10*m_changeValue/100.0;
    double arrow_compare2 = 5*m_changeValue/100.0;
