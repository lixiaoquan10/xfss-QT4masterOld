...
public:
    ...
    void uploadStatus(int ntype, int nCanportID, int nDisID, int nLoopID, int nDeviceID, int nStatus, int nValue, int nTimes, QString strtext="", int nloginstatus=0, int nCommunicationStatus=0, QString strdata="");
