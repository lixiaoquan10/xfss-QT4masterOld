...
/////////4:device status
/////////5:loop status
void CProcessBase::uploadStatus(int ntype, int nCanportID, int nDisID, int nLoopID, int nDeviceID, int nStatus, int nValue, int nTimes, QString strtext, int nLoginStatus, int nCommunicationStatus, QString strdata)
{
    ...
    objectStatus.nCanportID = nCanportID;
