...
//        distribution->setDistributionValue(DISTRIBUTION_VALUE_NAME, tr("Distribution%1").arg(query.value(fieldAddressId).toInt()));
//        distribution->setDistributionValue(DISTRIBUTION_VALUE_DESCRIPTION, tr("distribution+power"));
//        distribution->setDistributionValue(DISTRIBUTION_VALUE_DESCRIPTION, tr("Distribution"));
//        distribution->setDistributionValue(DISTRIBUTION_VALUE_DATABASE, 1);
...
void CDistribution::adjustedDeviceOnlineTotal(int adj)
{
    ...
    setDistributionValue(OBJECT_VALUE_ONLINE_COUNT, m_deviceOnlineTotal);
}
