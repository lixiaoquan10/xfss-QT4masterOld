...
{
    qDebug() << "CClientBusiness::setCommunicationConfig" << QDateTime::currentDateTime().toString("HH:mm:ss:zzz");
...
void CClientBusiness::recvData(int nMsgType, QByteArray &data)
{
    ...
    qDebug() << "CClientBusiness::recvData, msg type is " << type << QDateTime::currentDateTime().toString("HH:mm:ss:zzz");
    if(!msgStruct)
        return;
    switch(type)
    {
        case NCT_ObjectStatus:
        {
            ...
            qDebug() << "CClientBusiness::recvData, NCT_ObjectStatus " << msgObjectStatus->nType  << QDateTime::currentDateTime().toString("HH:mm:ss:zzz");
...
//    }
    ...
    qDebug() << "CClientBusiness::objectStatusChanged" << QDateTime::currentDateTime().toString("HH:mm:ss:zzz");
}
