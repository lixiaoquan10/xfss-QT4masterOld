...
{
    //集中电源软件版本
    ui->label_CPUnumber->setText(distribution->value(DISTRIBUTION_VALUE_CPUVERSION).toString());
    ui->label_POWnumber->setText(distribution->value(DISTRIBUTION_VALUE_POWVERSION).toString());
    ui->label_LCDnumber->setText(distribution->value(DISTRIBUTION_VALUE_LCDVERSION).toString());
    ui->label_ABUS1number->setText(distribution->value(DISTRIBUTION_VALUE_ABUS1VERSION).toString());
    ui->label_ABUS2number->setText(distribution->value(DISTRIBUTION_VALUE_ABUS2VERSION).toString());
    ui->label_ABUS3number->setText(distribution->value(DISTRIBUTION_VALUE_ABUS3VERSION).toString());
    ui->label_ABUS4number->setText(distribution->value(DISTRIBUTION_VALUE_ABUS4VERSION).toString());
    ui->label_ABUS5number->setText(distribution->value(DISTRIBUTION_VALUE_ABUS5VERSION).toString());
    ui->label_ABUS6number->setText(distribution->value(DISTRIBUTION_VALUE_ABUS6VERSION).toString());
    ui->label_ABUS7number->setText(distribution->value(DISTRIBUTION_VALUE_ABUS7VERSION).toString());
    ui->label_ABUS8number->setText(distribution->value(DISTRIBUTION_VALUE_ABUS8VERSION).toString());
