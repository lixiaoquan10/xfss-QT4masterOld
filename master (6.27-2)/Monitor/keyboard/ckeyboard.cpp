...
{
    qDebug() << "CKeyboard::saveFocusWidget" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    Q_UNUSED(oldFocus);
...
{
    qDebug() << "CKeyboard::buttonClicked" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CKeyboard::getFocusedWidget" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CKeyboard::on_pushButton_close_clicked" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CKeyboard::PushButton_Init" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
