...
{
    qDebug() << "CFirePoint::createTable" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CFirePoint::loadFirePoint" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CFirePoint::setFirePointValue" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    QVariant old;
...
{
    qDebug() << "CFirePoint::codeStr" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(m_controller)
...
{
    qDebug() << "CFirePoint::initFirePoint" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    m_controller = NULL;
...
{
    qDebug() << "CFirePoint::saveFirePoint" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(isUndefined())
        return 0;
