...
{
    qDebug() << "CLayer::setLayerValue" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    QVariant old;
...
{
    qDebug() << "CLayer::loadLayer" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CLayer::descriptionStr" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(m_parentLayer)
    {
...
{
    qDebug() << "CLayer::setController" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CLayer::addChildLayer" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!layer)
        return false;
...
{
    qDebug() << "CLayer::removeChildLayer" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!layer)
        return;
    if(!m_childLayers.contains(layer))
        return;
...
{
    qDebug() << "CLayer::initLayer" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    m_controller = NULL;
    m_parentLayer = NULL;
