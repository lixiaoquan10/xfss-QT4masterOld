...
{
    qDebug() << "CBottomToolBar::createToolBar" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    QFont font;
...
{
    qDebug() << "CBottomToolBar::getCurrentDateTime" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    QString strWeek = "";
...
{
    qDebug() << "CBottomToolBar::setUser" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CBottomToolBar::setAdministrator" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CBottomToolBar::setManual" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CBottomToolBar::setAuto" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
