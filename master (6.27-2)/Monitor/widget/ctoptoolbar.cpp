...
{
    qDebug() << "CTopToolBar::initMember" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    m_menuBrowse = NULL;
    m_menuRegedit = NULL;
    m_menuManage = NULL;
    m_menuSystem = NULL;
...
{
    qDebug() << "CTopToolBar::createCheckTime" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    QFont font;
...
{
    qDebug() << "CTopToolBar::createToolBar" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    createCheckTime();
    QFont font;
...
{
    qDebug() << "CTopToolBar::createCheckMenu" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::createEmergencyMenu" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::createBrowseMenu" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::createRegMenu" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::createListMenu" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::createManageMenu" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::createSystemMenu" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::slotShowCheckMenu" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::slotShowEmergencyMenu" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::slotShowRegMenu" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::slotShowListMenu" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::slotShowBrowseMenu" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::slotShowManageMenu" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::slotShowSystemMenu" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::slotMuteSystem" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    CMsgNull m_MsgNUll;
    m_btnMuteTool->setChecked(true);
...
{
    qDebug() << "CTopToolBar::slotResetSystem" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    CMsgNull m_MsgNUll;
...
{
    qDebug() << "CTopToolBar::resetSystem" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    CMsgNull m_MsgNUll;
...
{
    qDebug() << "CTopToolBar::resetAllDevice" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "resetThread::run" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::slot_threadFinished" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    // 获取发送信号的线程对象
...
{
    qDebug() << "CTopToolBar::slot_updateStatus" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    object->setStatus(status, value);
}

void CTopToolBar::slotCheckLoginInfo()
{
    qDebug() << "CTopToolBar::slotCheckLoginInfo" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::slotStart" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    dlgAdministrator m_Administrator;
    m_Administrator.setWindowTitle("用户验证");
    m_Administrator.setUserDisabled(true);
    if(QDialog::Accepted == m_Administrator.exec())
...
{
    qDebug() << "CTopToolBar::slotStop" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    CMsgNull m_MsgNUll;
    dlgAdministrator m_Administrator;
    m_Administrator.setWindowTitle("用户验证");
    m_Administrator.setUserDisabled(true);
...
{
    qDebug() << "CTopToolBar::slotHandFire" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::slotDeviceInfo" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    // 替换界面
...
{
    qDebug() << "CTopToolBar::slotCanInfo" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::slotDayInformation" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::slotWeekInformation" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    CGlobal::instance()->SystemRecord()->setPage(1);
...
{
    qDebug() << "CTopToolBar::slotLogging" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    CGlobal::instance()->SystemRecord()->setPage(1);
    // 替换界面
    changeCenterFrameWidget(CGlobal::instance()->SystemRecord());
...
{
    qDebug() << "CTopToolBar::slotSearchDevice" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::slotListView" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    // 替换界面
...
{
    qDebug() << "CTopToolBar::slotLayoutView" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    // 替换界面
...
{
    qDebug() << "CTopToolBar::slotSelfTest" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    CMsgNull m_MsgNUll;
    m_btnManageTool->setChecked(true);
...
{
    qDebug() << "CTopToolBar::slotMonthlyTest" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    CMsgNull m_MsgNUll;
    dlgAdministrator m_Administrator;
    m_Administrator.setWindowTitle("用户验证");
    m_Administrator.setUserDisabled(true);
...
{
    qDebug() << "CTopToolBar::slotYearTest" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    CMsgNull m_MsgNUll;
    dlgAdministrator m_Administrator;
    m_Administrator.setWindowTitle("用户验证");
    m_Administrator.setUserDisabled(true);
...
{
    qDebug() << "CTopToolBar::slotManual" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    CMsgNull m_MsgNUll;
...
{
    qDebug() << "CTopToolBar::slotAuto" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    CMsgNull m_MsgNUll;
    if(CGlobal::instance()->m_HaveDialog)
        return;
    dlgAdministrator m_Administrator;
...
{
    qDebug() << "CTopToolBar::slotSystemSetup" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::slotStartSimulateTime" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    CMsgNull m_MsgNUll;
    dlgAdministrator m_Administrator;
    m_Administrator.setWindowTitle("用户验证");
    m_Administrator.setUserDisabled(true);
...
{
    qDebug() << "CTopToolBar::slotStopSimulateTime" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    CMsgNull m_MsgNUll;
    m_speedup = false;
...
{
    qDebug() << "CTopToolBar::slotSaveDeviceData" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::slotSaveDeviceStatus" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    QString  data = QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss") + "\n";
...
{
    qDebug() << "CTopToolBar::slotOutUSB" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::slotAbout" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    CCanport* canport = CGlobal::instance()->controller()->canportByAddress(9);
    CDistribution* distribution = canport->distributionByAddress(1);
    CGlobal::instance()->m_HaveDialog = true;
    // 创建一个QFont对象并设置字体属性
    QFont font;
    font.setPointSize(12); // 设置字体大小为12像素
...
{
    qDebug() << "CTopToolBar::slotUpdateLog" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    CGlobal::instance()->m_HaveDialog = true;
    // 创建一个QFont对象并设置字体属性
    QFont font;
    font.setPointSize(12); // 设置字体大小为12像素
...
{
    qDebug() << "CTopToolBar::slotReStart" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    CGlobal::instance()->m_HaveDialog = true;
    QFont font;
    font.setPointSize(12); // 设置字体大小为12像素
    // 在QMessageBox中设置字体
...
{
    qDebug() << "CTopToolBar::slotLogin" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    dlgAdministrator m_Administrator;
...
{
    qDebug() << "CTopToolBar::slotLogout" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::changeInformation" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if (flag)
    {
...
{
    qDebug() << "CTopToolBar::updateMenu" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::changeCenterFrameWidget" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CTopToolBar::emergencyStatusClear" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    for(int i=3; i<=CGlobal::instance()->m_nCanNumber+2; i++)
    {
        CCanport* canport = CGlobal::instance()->controller()->canportByAddress(i);
        if(!canport)
