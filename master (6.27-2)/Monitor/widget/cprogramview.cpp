...
{
    qDebug() << "CProgramView::slot_resetControllerView" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramView::slot_regALL" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    QFont font;
...
{
    qDebug() << "CProgramView::slot_unLogin" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    m_isRemoveLoop = false;
    QFont font;
    font.setPointSize(12); // 设置字体大小为12像素
    // 在QMessageBox中设置字体
...
{  
    qDebug() << "CProgramView::slot_regLoop" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    QFont font;
    font.setPointSize(12); // 设置字体大小为12像素
    int ret = 0;
...
{
    qDebug() << "CProgramView::slot_unLoginLoop" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    QFont font;
    font.setPointSize(12); // 设置字体大小为12像素
    // 在QMessageBox中设置字体
    QMessageBox messageBox;
...
{
    qDebug() << "CProgramView::slot_removeLoginObject" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(m_isRemoveLoop)
...
{
    qDebug() << "CProgramView::slot_recodeAllDevice" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    int deviceAdd;
...
{
    qDebug() << "CProgramView::slot_recodeLoopDevice" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    int deviceAdd;
    CCanport* canport = CGlobal::instance()->controller()->canportByAddress(CGlobal::instance()->m_nCanportAddress);
    if(canport){
       CDistribution* distribution = canport->distributionByAddress(CGlobal::instance()->m_nDistriAddress);
...
{
    qDebug() << "CProgramView::setController" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramView::slot_saveAllDevice" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    int deviceAdd;
    bool reflag = false;
    for(int i=3; i<=CGlobal::instance()->m_nCanNumber+2; i++)
    {
...
{
    qDebug() << "CProgramView::slot_saveLoopDevice" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    QFont font;
    font.setPointSize(12); // 设置字体大小为12像素
    QString styleSheet = "QMessageBox { border: 1px solid #333333; }";
    int deviceAdd;
