...
{
    qDebug() << "CDesignSplashView::ScrollBarChange" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDesignSplashView::slot_spliderValueChanged" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    m_sliderValue = value;
...
{
    qDebug() << "CDesignSplashView::slot_setSliderChanged" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    m_slidertimer->stop();
...
{
    qDebug() << "CDesignSplashView::slot_enlarge" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDesignSplashView::slot_reduction" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDesignSplashView::sliderReset" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    m_verticalSlider->setValue(100);
    slot_spliderValueChanged(m_verticalSlider->value());
}
...
{
    qDebug() << "CDesignSplashView::onVerticalScroll" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    m_labelAddress->hide();
...
{
    qDebug() << "CDesignSplashView::onHorizontalScroll" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    m_labelAddress->hide();
...
{
    qDebug() << "CDesignSplashView::setMainPicture" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    m_pView->setPixmap(QPixmap("/home/xfss/root/PageBackgroundFolder/main.png"));
    isHideSlider(true);
}
//设置布局视图
...
{
    qDebug() << "CDesignSplashView::setPixmap" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    // 获取background图片尺寸
...
{
    qDebug() << "CDesignSplashView::isHideSlider" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(istrue)
    {
        m_label->hide();
        m_enlarge->hide();
...
{
    qDebug() << "CDesignSplashView::slot_setPrimitiveItem" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDesignSplashView::setPrimitiveItem" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!CGlobal::instance()->designTreeView()->CurrentLayer())
        return;
...
{
    qDebug() << "CDesignSplashView::rotatePoint" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDesignSplashView::mouseMoveEvent" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    m_labelAddress->hide();
...
{
    QWidget::mousePressEvent(event);
    qDebug() << "CDesignSplashView::mousePressEvent" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    // 点击事件，只能时滑动时间的开始
    m_moveEnd = false;
...
{
    qDebug() << "CDesignSplashView::createTableMenu" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    m_device = device;
...
{
    qDebug() << "CDesignSplashView::setFirePointPrimitiveItem" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    // 在背景上绘制图案
...
{
    qDebug() << "CDesignSplashView::setLampToFirePoint" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    //坐标、高度、宽度需要乘上放大倍数
...
{
    qDebug() << "CDesignSplashView::setLampConnectionArrow" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDesignSplashView::setArrowPrimitiveItem" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    // 在背景上绘制图案
    QPainter painter(background);
    painter.setRenderHint(QPainter::Antialiasing, true);
...
{
    qDebug() << "CDesignSplashView::setLeftArrowPrimitiveItem" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    // 在背景上绘制图案
    QPainter painter(background);
    painter.setRenderHint(QPainter::Antialiasing, true);
...
{
    qDebug() << "CDesignSplashView::setRightArrowPrimitiveItem" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    // 在背景上绘制图案
    QPainter painter(background);
    painter.setRenderHint(QPainter::Antialiasing, true);
...
{
    qDebug() << "CDesignSplashView::setLeftFPrimitiveItem" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    // 在背景上绘制图案
    QPainter painter(background);
    painter.setRenderHint(QPainter::Antialiasing, true);
...
{
    qDebug() << "CDesignSplashView::setFloorPrimitiveItem" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    // 在背景上绘制图案
    QPainter painter(background);
    painter.setRenderHint(QPainter::Antialiasing, true);
...
{
    qDebug() << "CDesignSplashView::setExitPrimitiveItem" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    // 在背景上绘制图案
    QPainter painter(background);
    painter.setRenderHint(QPainter::Antialiasing, true);
...
{
    qDebug() << "CDesignSplashView::setChangeExitPrimitiveItem" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    // 在背景上绘制图案
    QPainter painter(background);
    painter.setRenderHint(QPainter::Antialiasing, true);
...
{
    qDebug() << "CDesignSplashView::setLightPrimitiveItem" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    // 在背景上绘制图案
    QPainter painter(background);
    painter.setRenderHint(QPainter::Antialiasing, true);
...
{
    qDebug() << "CDesignSplashView::setOneUndergroundPrimitiveItem" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    // 在背景上绘制图案
    QPainter painter(background);
    painter.setRenderHint(QPainter::Antialiasing, true);
...
{
    qDebug() << "CDesignSplashView::setDoubleUndergroundPrimitiveItem" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    // 在背景上绘制图案
    QPainter painter(background);
    painter.setRenderHint(QPainter::Antialiasing, true);
...
{
    qDebug() << "CDesignSplashView::slot_Lighten" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
...
{
    qDebug() << "CDesignSplashView::slot_CloseLight" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
    CMsgObjectStatus msgobjectstatus;
    msgobjectstatus.nCanportAdd = m_device->canportAdd();
...
{
    qDebug() << "CDesignSplashView::slot_Left" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    int direction = 0x05;
    if(!m_device)
        return;
...
{
    qDebug() << "CDesignSplashView::slot_Right" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    int direction = 0x06;
    if(!m_device)
        return;
...
{
    qDebug() << "CDesignSplashView::slot_AllBright" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    int direction = 0x07;
    if(!m_device)
        return;
    m_device->setDeviceValue(DEVICE_VALUE_LEFTCLOSE,0);
...
{
    qDebug() << "CDesignSplashView::slot_AllClose" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    int direction = 0x04;
    if(!m_device)
        return;
    m_device->setDeviceValue(DEVICE_VALUE_LEFTCLOSE,1);
...
{
    qDebug() << "CDesignSplashView::slot_DefaultLeft" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
    CMsgObjectStatus msgobjectstatus;
    msgobjectstatus.nCanportAdd = m_device->canportAdd();
...
{
    qDebug() << "CDesignSplashView::slot_DefaultRight" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
    CMsgObjectStatus msgobjectstatus;
    msgobjectstatus.nCanportAdd = m_device->canportAdd();
...
{
    qDebug() << "CDesignSplashView::slot_DefaultAll" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
    CMsgObjectStatus msgobjectstatus;
    msgobjectstatus.nCanportAdd = m_device->canportAdd();
...
{
    qDebug() << "CDesignSplashView::slot_DefaultOff" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
    CMsgObjectStatus msgobjectstatus;
    msgobjectstatus.nCanportAdd = m_device->canportAdd();
...
{
    qDebug() << "CDesignSplashView::slot_Reverse" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDesignSplashView::slot_NoReverse" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDesignSplashView::slot_StartTest" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
    CMsgObjectStatus msgObjectStatus;
    msgObjectStatus.nCanportAdd = m_device->canportAdd();
...
{
    qDebug() << "CDesignSplashView::slot_StopTest" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
    CMsgObjectStatus msgObjectStatus;
    msgObjectStatus.nCanportAdd = m_device->canportAdd();
...
{
    qDebug() << "CDesignSplashView::slot_StartEmergency" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
...
{
    qDebug() << "CDesignSplashView::slot_StopEmergency" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
    if(m_device->getDeviceCommunicationFault())
        return;
...
{
    qDebug() << "CDesignSplashView::slot_CloseBatteryOut" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
    CMsgObjectStatus msgobjectstatus;
    msgobjectstatus.nCanportAdd = m_device->canportAdd();
...
{
    qDebug() << "CDesignSplashView::slot_BatteryOutKeep" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
    CMsgObjectStatus msgobjectstatus;
    msgobjectstatus.nCanportAdd = m_device->canportAdd();
...
{
    qDebug() << "CDesignSplashView::slot_DeviceInfo" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
