...
{
    qDebug() << "CProgramDistributionView::readProtectInfo" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramDistributionView::distributionResetStatus" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    for(int i=3; i<=CGlobal::instance()->m_nCanNumber+2; i++)
    {
        CCanport* canport = CGlobal::instance()->controller()->canportByAddress(i);
        if(!canport)
...
{
    qDebug() << "CProgramDistributionView::setDistribution" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    CMsgObjectStatus msgObjectStatus;
    msgObjectStatus.nDisID = distribution->distributionAddress();
    msgObjectStatus.nCanportAdd = distribution->canportAddress();
    //读取保护参数
...
{
    qDebug() << "CProgramDistributionView::updateStatus" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramDistributionView::setDistributionStatus" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramDistributionView::setLoopStatus" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramDistributionView::on_m_opencurrent_slider_valueChanged" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramDistributionView::on_m_firetime_slider_valueChanged" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramDistributionView::on_m_unfiretime_slider_valueChanged" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramDistributionView::on_CAN_communication_clicked" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(m_changeflag != true)
        return;
    CCanport* canport = CGlobal::instance()->controller()->canportByAddress(CGlobal::instance()->m_nCanportAddress);
    if(canport)
...
{
    qDebug() << "CProgramDistributionView::on_light_detection_clicked" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(m_changeflag != true)
        return;
    CCanport* canport = CGlobal::instance()->controller()->canportByAddress(CGlobal::instance()->m_nCanportAddress);
    if(canport)
...
{
    qDebug() << "CProgramDistributionView::on_comboBox_powermode_currentIndexChanged" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(m_changeflag != true)
        return;
    CCanport* canport = CGlobal::instance()->controller()->canportByAddress(CGlobal::instance()->m_nCanportAddress);
    if(canport)
...
{
    qDebug() << "CProgramDistributionView::on_comboBox_linkageInput_currentIndexChanged" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(m_changeflag != true)
        return;
    CCanport* canport = CGlobal::instance()->controller()->canportByAddress(CGlobal::instance()->m_nCanportAddress);
    if(canport)
...
{
    qDebug() << "CProgramDistributionView::on_comboBox_loopoutstatus_currentIndexChanged" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(m_changeflag != true)
        return;
...
{
    qDebug() << "CProgramDistributionView::on_readloopoutstatus_button_clicked" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(m_changeflag != true)
        return;
    CMsgObjectStatus msgobjectstatus;
    msgobjectstatus.nDisID = CGlobal::instance()->m_nDistriAddress;
...
{
    qDebug() << "CProgramDistributionView::on_closepowerout_button_clicked" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(m_changeflag != true)
        return;
    CMsgObjectStatus msgobjectstatus;
    msgobjectstatus.nDisID = CGlobal::instance()->m_nDistriAddress;
...
{
    qDebug() << "CProgramDistributionView::on_poweroutkeep_button_clicked" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(m_changeflag != true)
        return;
    CMsgObjectStatus msgobjectstatus;
    msgobjectstatus.nDisID = CGlobal::instance()->m_nDistriAddress;
...
{
    qDebug() << "CProgramDistributionView::on_emergencyStart_button_clicked" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    CMsgObjectStatus msgobjectstatus;
    msgobjectstatus.nDisID = CGlobal::instance()->m_nDistriAddress;
...
{
    qDebug() << "CProgramDistributionView::on_emergencyStop_button_clicked" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    CMsgObjectStatus msgobjectstatus;
    msgobjectstatus.nDisID = CGlobal::instance()->m_nDistriAddress;
    msgobjectstatus.nLoopID = ui->comboBox_loopAddress->currentIndex();
    msgobjectstatus.nValue = false;
...
{
    qDebug() << "CProgramDistributionView::read" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    QFont font;
