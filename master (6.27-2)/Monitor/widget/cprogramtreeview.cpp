...
{
    qDebug() << "CProgramTreeView::resetControllerTreeView" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    // 保存当前选择的索引
...
{
    qDebug() << "CProgramTreeView::setController" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramTreeView::newController" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramTreeView::openController" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramTreeView::closeController" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramTreeView::saveController" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramTreeView::slotNewController" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    newController();
}

void CProgramTreeView::slotOpenController()
{
    qDebug() << "CProgramTreeView::slotOpenController" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    openController();
...
{
    qDebug() << "CProgramTreeView::slotCloseController" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramTreeView::slotSelectionChanged" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    Q_UNUSED(deselected);
    if(selected.isEmpty())
        return;
