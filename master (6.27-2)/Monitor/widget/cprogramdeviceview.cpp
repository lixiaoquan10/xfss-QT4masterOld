...
{
    qDebug() << "CProgramDeviceView::eventFilter" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramDeviceView::createTableMenu" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramDeviceView::isNewLamp" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramDeviceView::on_tableView_clicked" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramDeviceView::type" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
//    int typeId = device->deviceTypeId();
...
{
    qDebug() << "CProgramDeviceView::slot_ChangeAdd" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramDeviceView::slot_ChangeDeviceType" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramDeviceView::slot_Lighten" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
...
{
    qDebug() << "CProgramDeviceView::slot_CloseLight" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
    CMsgObjectStatus msgObjectStatus;
    msgObjectStatus.nCanportAdd = m_device->canportAdd();
...
{
    qDebug() << "CProgramDeviceView::slot_AllClose" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    int direction;
    direction = 0x04;
    if(!m_device)
        return;
...
{
    qDebug() << "CProgramDeviceView::slot_Left" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    int direction;
    direction = 0x05;
    if(!m_device)
        return;
...
{
    qDebug() << "CProgramDeviceView::slot_Right" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    int direction;
    direction = 0x06;
    if(!m_device)
        return;
...
{
    qDebug() << "CProgramDeviceView::slot_StartTest" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
    CMsgObjectStatus msgObjectStatus;
    msgObjectStatus.nCanportAdd = m_device->canportAdd();
...
{
    qDebug() << "CProgramDeviceView::slot_StopTest" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
    CMsgObjectStatus msgObjectStatus;
    msgObjectStatus.nCanportAdd = m_device->canportAdd();
...
{
    qDebug() << "CProgramDeviceView::slot_StartEmergency" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
...
{
    qDebug() << "CProgramDeviceView::slot_StopEmergency" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
    if(m_device->getDeviceCommunicationFault())
        return;
...
{
    qDebug() << "CProgramDeviceView::slot_ReadLampVersion" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
...
{
    qDebug() << "CProgramDeviceView::slot_CloseBatteryOut" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
    CMsgObjectStatus msgObjectStatus;
    msgObjectStatus.nCanportAdd = m_device->canportAdd();
...
{
    qDebug() << "CProgramDeviceView::slot_BatteryOutKeep" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!m_device)
        return;
    CMsgObjectStatus msgObjectStatus;
    msgObjectStatus.nCanportAdd = m_device->canportAdd();
...
{
    qDebug() << "CProgramDeviceView::slot_uploadOldLamp" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
