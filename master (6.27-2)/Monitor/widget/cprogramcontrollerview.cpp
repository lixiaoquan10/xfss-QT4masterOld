...
{
    qDebug() << "CProgramControllerView::on_pushButtonSet_clicked" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramControllerView::addCanport" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramControllerView::delCanport" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
