...
{
    qDebug() << "CCanDataByteArray::getNotNullIndexList" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    QList<int> tmpList;
...
{
    qDebug() << "CCanDataByteArray::getDataFromIndex" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(m_hashDataTable.contains(port)){
...
{
    qDebug() << "CCanDataByteArray::appendData" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
