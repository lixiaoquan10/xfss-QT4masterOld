...
CDistributionModel::CDistributionModel(CCanport* canport, bool track, QObject *parent) :
    CModel(parent), m_canport(0)
{
    setTrack(track);
    setCanport(canport);
...
void CDistributionModel::setCanport(CCanport *canport)
{
