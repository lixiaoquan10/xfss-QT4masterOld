...
public:
    ...
    QCheckBox *onlyStartDistributionCheckBox;
    ...
    void setupUi(QDialog *dlgTimeInterval)
    {
        ...
        EnergyModeBox->setGeometry(QRect(940, 20, 120, 60));
        ...
        MYcheckTimeBox->setGeometry(QRect(600, 180, 140, 90));
        ...
        EmergencyBox->setGeometry(QRect(630, 20, 260, 110));
        ...
        VersionBox->setGeometry(QRect(50, 130, 270, 140));
        ...
        label_11->setMinimumSize(QSize(65, 28));
        label_11->setMaximumSize(QSize(65, 28));
        ...
        label_15->setMinimumSize(QSize(65, 28));
        label_15->setMaximumSize(QSize(65, 28));
        ...
        hostIPSetBox->setGeometry(QRect(1010, 140, 270, 170));
        ...
        UseTimeBox->setGeometry(QRect(360, 180, 200, 70));
        ...
        timeBox->setGeometry(QRect(780, 160, 190, 140));
        ...
        StartRuleBox->setGeometry(QRect(400, 20, 180, 130));
        ...
        onlyStartDistributionCheckBox = new QCheckBox(StartRuleBox);
        onlyStartDistributionCheckBox->setObjectName(QString::fromUtf8("onlyStartDistributionCheckBox"));
        onlyStartDistributionCheckBox->setFont(font1);

        verticalLayout_15->addWidget(onlyStartDistributionCheckBox);

        CanNumberBox = new QGroupBox(dlgTimeInterval);
        CanNumberBox->setObjectName(QString::fromUtf8("CanNumberBox"));
        CanNumberBox->setGeometry(QRect(1110, 20, 120, 80));
    ...
    void retranslateUi(QDialog *dlgTimeInterval)
    {
        ...
        onlyStartDistributionCheckBox->setText(QApplication::translate("dlgTimeInterval", "\345\220\257\345\212\250\346\211\200\345\234\250\351\233\206\344\270\255\347\224\265\346\272\220", 0, QApplication::UnicodeUTF8));
