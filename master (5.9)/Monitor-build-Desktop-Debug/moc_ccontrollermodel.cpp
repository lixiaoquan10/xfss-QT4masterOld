...
static const char qt_meta_stringdata_CControllerModel[] = {
    "CControllerModel\0\0type,object\0"
...
void CControllerModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        CControllerModel *_t = static_cast<CControllerModel *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData CControllerModel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CControllerModel::staticMetaObject = {
    { &CModel::staticMetaObject, qt_meta_stringdata_CControllerModel,
      qt_meta_data_CControllerModel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CControllerModel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CControllerModel))
        return static_cast<void*>(const_cast< CControllerModel*>(this));
