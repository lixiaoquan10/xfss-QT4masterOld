...
{
    qDebug() << "CCommunicationManager::setTestLinkageCom" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(enable)
        m_testReciveTimer.start(30);
    else
...
{
    qDebug() << "CCommunicationManager::setLinkageBaudRate" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CCommunicationManager::getPortFromCommunicationType" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    switch(type)
    {
        case CT_CanCard1:
            return 1;
...
{
    qDebug() << "CCommunicationManager::createCommunicationLine" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CCommunicationManager::open" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(m_hashCommunicationLine.contains(lineName)){
...
{
    qDebug() << "CCommunicationManager::close" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(m_hashCommunicationLine.contains(lineName)){
