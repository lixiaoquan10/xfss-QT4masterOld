...
{
    qDebug() << "CDM::save" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDM::load" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    m_isLoading = true;
...
int CDM::loadDefault()
{
    qDebug() << "CDM::loadDefault" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    clear();
    m_isLoad = true;
    CController* controller = new CController(1);
    addController(controller);
...
{
    qDebug() << "CDM::addController" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDM::removeController" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(controller != NULL && m_controllers.contains(controller))
    {
...
{
    qDebug() << "CDM::addObject" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDM::removeObject" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(object != NULL && m_objects.contains(object->keyId()))
    {
...
{
    qDebug() << "CDM::hasSecondCode" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDM::hasFirePoint" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(address.isEmpty())
        return false;
...
{
    qDebug() << "CDM::clearStatusObjects" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDM::clearUndefinedObjects" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
void CDM::clear()
{
    qDebug() << "CDM::clear" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
//    CProgress progress(CGlobal::instance()->taProcess());
//    if(progress.isValid())
//    {
...
{
    qDebug() << "CDM::editStatusChanged" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDM::objectStatusChanged" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDM::objectChanged" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDM::secondCodeChanged" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDM::objectDestrory" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDM::insert" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    int keyId = object->keyId();
...
{
    qDebug() << "CDM::remove" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    int keyId = object->keyId();
    QString type = object->type();
...
{
    qDebug() << "CDM::addChild" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDM::removeChild" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    QList<CObject*> childs = parent->childs();
    for(int i = 0; i < childs.size(); ++i)
    {
...
{
    qDebug() << "CDM::addNeedUpdateEvacuationLayer" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(layer)
...
{
    qDebug() << "CDM::removeNeedUpdateEvacuationLayer" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(layer)
...
{
    qDebug() << "CDM::createTable" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDM::clearTable" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDM::addStatusObject" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDM::removeStatusObject" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDM::addUndefinedObject" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDM::removeUndefinedObject" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDM::removeNotUsingMap" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
