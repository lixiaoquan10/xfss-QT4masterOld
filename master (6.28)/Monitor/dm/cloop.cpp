...
{
    qDebug() << "CLoop::setloopValue" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CLoop::getLoopCommunicationFault" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CLoop::createTable" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CLoop::loadLoop" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CLoop::codeStr" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(m_distribution)
...
{
    qDebug() << "CLoop::addDevice" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!device)
        return false;
...
{
    qDebug() << "CLoop::removeDevice" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(!device)
        return;
    if(!m_devices.contains(device))
        return;
...
{
    qDebug() << "CLoop::deviceById" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    for(int i = 0; i < m_devices.size(); ++i)
    {
...
{
    qDebug() << "CLoop::deviceByAdd" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    for(int i = 0; i < m_devices.size(); ++i)
    {
...
{
    qDebug() << "CLoop::deviceByProductionId" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    for(int i = 0; i < m_devices.size(); ++i)
    {
...
{
    qDebug() << "CLoop::deviceByKeyId" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CLoop::setDeviceTypeNumber" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CLoop::adjustedDeviceTypeNumber" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CLoop::setDeviceOnlineNumber" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CLoop::adjustedDeviceOnlineNumber" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CLoop::setDeviceOnlineTotal" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CLoop::adjustedDeviceOnlineTotal" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CLoop::resetDeviceOnlineTotal" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
void CLoop::initLoop()
{
    qDebug() << "CLoop::initLoop" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    m_distribution = NULL;
    m_maxDeviceId = 0;
...
{
    qDebug() << "CLoop::saveLoop" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CLoop::saveDevice" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    for(int i = 0; i < m_devices.size(); ++i)
    {
