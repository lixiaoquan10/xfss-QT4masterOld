...
{
    qDebug() << "ConfigFileManager::ParseConfigFile" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "ConfigFileManager::SaveConfigFile" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "ConfigFileManager::ParseROOT" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "ConfigFileManager::ParseBRANCH_LEVEL1" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "ConfigFileManager::ParseBRANCH_LEVEL2" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    QDomNode childnode = node->toElement().firstChild();
    while(!childnode.isNull())
    {
...
{
    qDebug() << "ConfigFileManager::ParseBRANCH_LEVEL3" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    QDomNode childnode = node->toElement().firstChild();
    while(!childnode.isNull())
    {
...
{
    qDebug() << "ConfigFileManager::ParseBRANCH_LEVEL4" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "ConfigFileManager::SaveROOT" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "ConfigFileManager::SaveBranchLevel1" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "ConfigFileManager::SaveBranchLevel2" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "ConfigFileManager::SaveBranchLevel3" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "ConfigFileManager::SaveBranchLevel4" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "ConfigFileManager::SplitXmlStringInt" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    QVector<int> vParam;
    QString value;
...
{
    qDebug() << "ConfigFileManager::SplitXmlStringFloat" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
