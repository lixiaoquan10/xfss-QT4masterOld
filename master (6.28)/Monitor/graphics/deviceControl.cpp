...
{
    qDebug() << "deviceControl::restDeviceControl" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "deviceControl::saveDeviceControlFile" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "deviceControl::ParseROOT" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "deviceControl::ParseBRANCH_LEVEL1" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "deviceControl::SaveROOT" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "deviceControl::SaveBranchLevel1" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
