...
{
    qDebug() << "CCenterFrame::createLeftBox" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CCenterFrame::slotToggleLeftBox" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CCenterFrame::createToolButton" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
