...
{
    qDebug() << "CInformationLabel::setInformation" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    setText(info);
    if(info.isEmpty())
        hide();
    else
...
{
    qDebug() << "CInformationLabel::resetParentWidget" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CInformationLabel::resetSize" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
