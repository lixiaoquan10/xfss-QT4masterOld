...
{
    qDebug() << "CDesignTreeView::slot_autoPage" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDesignTreeView::setAutoPage" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    if(enable)
        m_timer->start(10000);
    else
        m_timer->stop();
...
{
    qDebug() << "CDesignTreeView::setController" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDesignTreeView::setLayer" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    QModelIndex index = m_designTreeModel->getIndex(layer);
    m_designTreeView->setCurrentIndex(index);
}
...
{
    qDebug() << "CDesignTreeView::slotSelectionChanged" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    Q_UNUSED(deselected);
    if(selected.isEmpty())
        return;
...
{
    qDebug() << "CDesignTreeView::slotStartDrag" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDesignTreeView::slotDragEnterEvent" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDesignTreeView::slotDragMoveEvent" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDesignTreeView::slotDropEvent" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CDesignTreeView::addLayer" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    CController* controller = m_designTreeModel->controller();
    if(!controller)
        return;
...
{
    qDebug() << "CDesignTreeView::delLayer" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    QModelIndexList indexs = m_designTreeView->selectionModel()->selectedRows();
