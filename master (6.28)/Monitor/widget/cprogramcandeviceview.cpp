...
{
    qDebug() << "CProgramCanDeviceView::readPowerInfo" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramCanDeviceView::setDistribution" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramCanDeviceView::updateStatus" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramCanDeviceView::setDistributionStatus" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramCanDeviceView::setDistributionParameter" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    //集中电源软件版本
...
{
    qDebug() << "CProgramCanDeviceView::batteryTStatus" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
    // 将无符号整数转换为有符号整数
...
{
    qDebug() << "CProgramCanDeviceView::setLoopStatus" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CProgramCanDeviceView::on_tableView_clicked" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
