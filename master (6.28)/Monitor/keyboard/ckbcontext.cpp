...
{
    qDebug() << "CKBContext::sendCharacter" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
{
    qDebug() << "CKBContext::updatePosition" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
