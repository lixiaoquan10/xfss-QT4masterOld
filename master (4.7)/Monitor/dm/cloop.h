...
public:
    ...
    void setDeviceOnlineTotal(int n, bool isloopfault = false);
    void adjustedDeviceOnlineTotal(int adj, bool isloopfault = false);
    void resetDeviceOnlineTotal();

    void setIsRemoveLogin(bool istrue) { m_isRemoveLogin = istrue; }
    bool isRemoveLogin() { return m_isRemoveLogin; }
protected:
