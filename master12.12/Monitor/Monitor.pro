...
#LIBS += -L../Monitor -lirrKlang
#LIBS += -L/usr/local/MCGS/sysroot-mcgs/usr/lib -lmcgs-hal
LIBS += -L../Monitor
TRANSLATIONS = Monitor_zh_CN.ts
#include("wmf/wmf.pri")

#INCLUDEPATH += ./irrKlang
...
SOURCES += main.cpp\
    ...
    widget/cprogramprojectview.cpp \
    widget/cprogramloopview.cpp \
...
HEADERS  += widget.h \
    ...
    widget/cprogramprojectview.h \
    widget/cprogramloopview.h \
...
FORMS += \
    ...
    widget/cprogramloopview.ui \
    widget/cprogramformulaview.ui \
    widget/cprogramdeviceview.ui \
    widget/cprogramcontrollerview.ui \
