...
static const char qt_meta_stringdata_CDesignTreeModel[] = {
    "CDesignTreeModel\0\0object\0"
...
void CDesignTreeModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        CDesignTreeModel *_t = static_cast<CDesignTreeModel *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData CDesignTreeModel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CDesignTreeModel::staticMetaObject = {
    { &CModel::staticMetaObject, qt_meta_stringdata_CDesignTreeModel,
      qt_meta_data_CDesignTreeModel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CDesignTreeModel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CDesignTreeModel))
        return static_cast<void*>(const_cast< CDesignTreeModel*>(this));
