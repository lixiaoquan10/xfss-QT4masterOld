...
static const char qt_meta_stringdata_CMsgCheckTime[] = {
    "CMsgCheckTime\0"
};
...
const QMetaObjectExtraData CMsgCheckTime::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CMsgCheckTime::staticMetaObject = {
    { &CMsgStructBase::staticMetaObject, qt_meta_stringdata_CMsgCheckTime,
      qt_meta_data_CMsgCheckTime, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CMsgCheckTime::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CMsgCheckTime))
        return static_cast<void*>(const_cast< CMsgCheckTime*>(this));
