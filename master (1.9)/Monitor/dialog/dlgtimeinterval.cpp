...
void dlgTimeInterval::on_pushButton_saveHostIP_clicked()
{
    ...
    setIPData(m_getTmpip, m_getTmpmask, m_getTmpgateway);
}
...
//设置IP地址
void dlgTimeInterval::setIPData(const QString& ipAddress, const QString& subnetMask, const QString& gateway)
{
//    QProcess process;
//        QString command = "sudo ifconfig enp1s0 192.168.3.101 netmask 255.255.255.0";
