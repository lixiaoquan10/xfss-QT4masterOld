...
{
    qDebug() << "setStatus" << QDateTime::currentDateTime().toString("yyyy-MM-dd HH:mm:ss:zzz");
...
//    qDebug() << "emit objectStatusChanged";
    emit objectStatusChanged(status, old, value, time);
}
