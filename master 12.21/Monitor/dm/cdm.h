...
public:
    ...
    CProject* projectAt(const int i);
    int projectSize() { return m_projects.size(); }
    QList<CProject*> projects() { return m_projects; }
...
//    bool hasAlarmPoint(const QString& address);
...
//    QHash<QString, CAlarmPoint*> m_alarmPoints;
//    CAlarmPoint* m_firstFireAlarmPoint;
