...
public:
    ...
    void sendEmergency(bool enable, short emergencyType);
    ...
    void DeviceDefaultDirection(CMsgObjectStatus *msgObjectStatus);
    void DeviceDirectionControl(CMsgObjectStatus *msgObjectStatus);
    void DeviceFlashConfig(CMsgObjectStatus *msgObjectStatus);
    void DeviceFlashControl(CMsgObjectStatus *msgObjectStatus);
    void ChangeControl(CMsgObjectStatus *msgObjectStatus);
    void CloseBatteryOut(CMsgObjectStatus *msgObjectStatus);
    void SetLoopOutStatus(CMsgObjectStatus *msgObjectStatus);
    void ReadLoopOutStatus(CMsgObjectStatus *msgObjectStatus);
    ...
    void print(int type, const QString& title);
    void setLedStatus(const int nLedID, const int nLedStatus);
    void DeviceAdd(CMsgObjectStatus *msgObjectStatus);
    void DeviceType(CMsgObjectStatus *msgObjectStatus);
    void manualDeviceEmergency(CMsgDeviceInfo* msgDeviceInfo, bool enable);
    void manualDeviceTest(CMsgDeviceInfo *msgDeviceInfo);
    void DeviceDefaultLighten(CMsgDeviceInfo *msgDeviceInfo, bool enable);
    void manualDeviceReset(CMsgDeviceInfo *msgDeviceInfo);
    void setSpeedUp(bool enable);
    bool isSpeedUp() const { return m_isSpeedUp; }
    bool hasStandbyPowerFault() const;
    bool isEmergencyStatus() const { return m_isEmergency||m_isForceEmergency||m_isFireEmergency||m_isInputEmergency||m_isRemoteEmergency;}
    ...
    bool isPrintWarning() const { return m_PrintWarning; }
    bool isPrintFault() const { return m_PrintFault; }
    bool isPrintOperation() const { return m_PrintOperation; }
...
private:
    ...
    bool m_isSendDirectionAndTwinkleByOne;
    bool m_isUCSendDirectionAndTwinkleByOne;
    int  m_TwinkleTime;
